...
DOM.selectionRectangle=new Tlayer("div",{parent:DOM.baseLayer.subLayers["selection"],  layerName: "selectionRectangle" });
 DOM.selectionRectangle=DOM.selectionRectangle.htmlObject;
  DOM.selectionRectangle.className = 'selection-rectangle';
    DOM.selectionRectangle.style.cssText = `
        position: absolute;
