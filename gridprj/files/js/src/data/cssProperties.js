/**
 * Bu modül, CSS özellikleri ve onların geçerli değerleri hakkında
 * meta verileri içeren JSON nesnesini barındırır.
 * Veriyi mantıktan ayırmak, yönetimi ve güncellemeyi kolaylaştırır.
 */
export const cssProps = {
    ...
    "container-type": {
      "moz": false,
      "webkit": false,
      "syntax": "(none)|(inline-size)|(block-size)|(size)|(initial)|(inherit)",
      "initial": "none",
      "values": [
        "none",
        "inline-size",
    ...
    "container-name": {
      "moz": false,
      "webkit": false,
      "syntax": "([custom-ident])|(none)|(initial)|(inherit)",
      "initial": "none",
      "values": [
        "[custom-ident]",
        "none",
    ...
    "scroll-snap-type": {
      "moz": false,
      "webkit": false,
      "syntax": "(none)|(x)|(y)|(both)|(mandatory)|(proximity)|(initial)|(inherit)",
      "initial": "none",
      "values": [
        "none",
        "x",
    ...
    "scroll-snap-align": {
      "moz": false,
      "webkit": false,
      "syntax": "(none)|(start)|(end)|(center)|(initial)|(inherit)",
      "initial": "none",
      "values": [
        "none",
        "start",
    ...
    "scroll-snap-stop": {
      "moz": false,
      "webkit": false,
      "syntax": "(normal)|(always)|(initial)|(inherit)",
      "initial": "normal",
      "values": [
        "normal",
        "always",
    ...
    "font-variation-settings": {
      "moz": false,
      "webkit": false,
      "syntax": "([string] [number])(, [string] [number])*|(normal)|(initial)|(inherit)",
      "initial": "normal",
      "values": [
        "[string] [number]",
        "normal",
    ...
    "print-color-adjust": {
      "moz": false,
      "webkit": false,
      "syntax": "(economy)|(exact)|(initial)|(inherit)",
      "initial": "economy",
      "values": [
        "economy",
        "exact",
    ...
    "overflow-wrap": {
      "moz": false,
      "webkit": false,
      "syntax": "(normal)|(break-word)|(anywhere)|(initial)|(inherit)",
      "initial": "normal",
      "values": [
        "normal",
        "break-word",
    ...
    "text-decoration-thickness": {
      "moz": true,
      "webkit": true,
      "syntax": "([length])|(from-font)|(initial)|(inherit)",
      "initial": "from-font",
      "values": [
        "[length]",
        "from-font",
    ...
    "aspect-ratio": {
      "moz": false,
      "webkit": false,
      "syntax": "([number])\\/([number])|(auto)|(initial)|(inherit)",
      "initial": "auto",
      "values": [
        "[number]/[number]",
        "auto",
        ...
        "moz": false,
        "webkit": false,
        "syntax": "(auto)|(contain)|(none)|(initial)|(inherit)",
        "initial": "auto",
        "values": [
          "auto",
          "contain",
      ...
      "backdrop-filter": {
        "moz": false,
        "webkit": true,
        "syntax": "([fn:blur])|([fn:brightness])|([fn:contrast])|([fn:drop-shadow])|([fn:grayscale])|([fn:hue-rotate])|([fn:invert])|([fn:opacity])|([fn:saturate])|([fn:sepia])|(none)|(initial)|(inherit)",
        "initial": "none",
        "values": [
          "[fn:blur]",
          "[fn:brightness]",
      ...
      "text-emphasis": {
        "moz": false,
        "webkit": true,
        "syntax": "(([prop:text-emphasis-style]) ([prop:text-emphasis-color]))|(none)|(initial)|(inherit)",
        "initial": "none",
        "values": [
          "[prop:text-emphasis-style]",
      ...
      "text-emphasis-style": {
        "moz": false,
        "webkit": true,
        "syntax": "(none)|(filled)|(open)|(dot)|(circle)|(initial)|(inherit)",
        "initial": "none",
        "values": [
          "none",
          "filled",
      ...
      "text-emphasis-position": {
        "moz": false,
        "webkit": true,
        "syntax": "(under)|(over)|(initial)|(inherit)",
        "initial": "under",
        "values": [
          "under",
          "over",
      ...
      "clip-path": {
        "moz": false,
        "webkit": true,
        "syntax": "(none)|([fn:url])|([fn:inset])|([fn:circle])|([fn:ellipse])|([fn:polygon])|(initial)|(inherit)",
        "initial": "none",
        "values": [
          "none",
          "[fn:url]",
      ...
      "mask": {
        "moz": false,
        "webkit": true,
        "syntax": "(none)|([fn:url])|([fn:linear-gradient])|(initial)|(inherit)",
        "initial": "none",
        "values": [
          "none",
          "[fn:url]",
      ...
      "color-scheme": {
        "moz": false,
        "webkit": false,
        "syntax": "(auto)|(light)|(dark)|(only)|(initial)|(inherit)",
        "initial": "auto",
        "values": [
          "auto",
          "light",
 ...
 "WhiteSmoke", "Yellow", "YellowGreen"
    ...
    "functions": {
        ...
        "drop-shadow": "drop-shadow(<offset-x> <offset-y> <blur-radius> <color>)",
        "ellipse": "ellipse(<radius-x> <radius-y>)",
        ...
        "polygon": "polygon(<fill-rule>, <points>)",
        "radial-gradient": "radial-gradient(<shape> at <position>, <color-stop>, <color-stop>)",
        "repeating-linear-gradient": "repeating-linear-gradient(<angle>, <color-stop>, <color-stop>)",
        "repeating-radial-gradient": "repeating-radial-gradient(<shape> at <position>, <color-stop>, <color-stop>)",
        "rotate": "rotate(<angle>)",
        ...
        "sepia": "sepia(<number>)",
        "skew": "skew(<angle-x>, <angle-y>)",
        "skewX": "skewX(<angle>)",
        "skewY": "skewY(<angle>)",
        "steps": "steps(<count>, <position>)",
